...
@androidx.room.Database(entities = {User.class, AccountInfo.class, BankStatement.class, Grades.class, Subjects.class, Absence.class}, version = 19, exportSchema = false)
